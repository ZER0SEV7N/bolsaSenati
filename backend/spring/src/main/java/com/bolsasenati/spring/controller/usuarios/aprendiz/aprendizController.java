package com.bolsasenati.spring.controller.usuarios.aprendiz;
...
import com.bolsasenati.spring.services.usuario.aprendiz.aprendizService;

//Controlador para manejar las rutas de actualización de perfil del aprendiz (intereses, contacto, contraseña)
//Todas las rutas requieren autenticación y actualizan el perfil del aprendiz autenticado
@RestController
@RequestMapping("/aprendiz")
public class aprendizController {

    @Autowired private aprendizService aprendizService;

    @Autowired private authServices authServices;

    //Endpoint PATCH: /aprendiz/intereses
    //Actualiza los intereses y palabras clave del aprendiz autenticado
    ...
    //Endpoint PATCH: /aprendiz/contacto
    //Actualiza la información de contacto del aprendiz autenticado (teléfono, dirección, etc.)
    // Similar a la ruta de intereses, pero con un DTO específico para contacto y un método de servicio diferente
    ...
    //Endpoint PATCH: /aprendiz/cambiar-password
    //Permite al aprendiz autenticado cambiar su contraseña actual por una nueva, 
    //validando la contraseña actual antes de actualizarla
